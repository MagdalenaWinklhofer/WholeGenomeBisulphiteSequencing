...
#SBATCH --job-name=Bismark_alignment_cc
...
#alignment paired end with unmapped output
./bismark --parallel 8 --un --non_directional --score_min L,0,-0.4 --samtools_path /cluster/software/SAMtools/1.16.1-GCC-11.3.0/bin/samtools \
--temp_dir /cluster/work/users/magdalena/DNA/5_bismark_alignment_minscore/ \
...
--output_dir /cluster/work/users/magdalena/DNA/5_bismark_alignment_minscore/${output[$SLURM_ARRAY_TASK_ID]}
