...
/cluster/projects/nn8014k/magdalena/.program_methylscore/nextflow run Computomics/MethylScore \
    --trace.overwrite \
    --FORCE_RERUN=0 \
    --PROJECT_FOLDER=/cluster/work/users/magdalena/DMR/data/DMR_N_vs_A_10 \
    --SAMPLE_SHEET=/cluster/work/users/magdalena/DMR/data/samplesheet_n_vs_a.tsv \
	--GENOME=/cluster/work/users/magdalena/DMR/data/ccar_genome_v1_262scaffolds_masked.fasta \
    -profile slurm \
    -work-dir /cluster/work/users/magdalena/DMR/data/DMR_N_vs_A_10/work \
    -resume \
