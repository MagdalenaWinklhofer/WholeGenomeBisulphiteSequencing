...
cp /cluster/projects/nn8014k/magdalena/WGBS/DNAseq_pipeline/5_dmr_identification/Methylscore/2_out_N_vs_A/output/03matrix/genome_matrix.tsv.gz \
 /cluster/projects/nn8014k/magdalena/WGBS/DNAseq_pipeline/6_extract_genome_matrix_information/NvsA/
