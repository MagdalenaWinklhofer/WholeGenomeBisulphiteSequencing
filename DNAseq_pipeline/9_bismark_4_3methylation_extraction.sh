...
./bismark_methylation_extractor --multicore 6 -p --comprehensive --gzip --parallel 6 \
 ...
 --output /cluster/work/users/magdalena/7_bismark_methylation_extraction/${output[$SLURM_ARRAY_TASK_ID]} \
