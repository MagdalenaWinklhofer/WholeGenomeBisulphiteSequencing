...
# noroxia vs reoxygenation
methylpy DMRfind \
	--allc-files allc_N1.tsv.gz allc_N2.tsv.gz allc_N3.tsv.gz allc_N7.tsv.gz allc_24R2.tsv.gz allc_24R3.tsv.gz allc_24R7.tsv.gz allc_24R8.tsv.gz \
	--samples N1 N2 N3 N7 24R2 24R3 24R7 24R8 \
	--sample-category 0 0 0 0 1 1 1 1 \
	--mc-type "CG" \
	--num-procs 2 \
	--output-prefix DMR_normoxia_vs_reoxygenation \
...
# noroxia vs reoxygenation merged 
#methylpy DMRfind \
#	--allc-files allc_normoxia.tsv.gz allc_reoxygenation.tsv.gz \
#	--samples normoxia reoxygenation \
#	--mc-type "CG" \
#	--num-procs 2 \
#	--output-prefix DMR_normoxia_vs_reoxygenation \
