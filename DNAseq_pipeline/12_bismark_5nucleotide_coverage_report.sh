...
#SBATCH --job-name=Bismark_coverage_merge_cc
...
cd /cluster/work/users/magdalena/10_bismark_nucleotide_coverage_report/
...
/cluster/projects/nn8014k/magdalena/.program_bismark/Bismark-0.24.1/bam2nuc \
 --samtools_path /cluster/software/SAMtools/1.17-GCC-12.2.0/bin/samtools \
 --genome_folder /cluster/projects/nn8014k/magdalena/script_WGBS/4_bismark_1index/ \
 --dir /cluster/work/users/magdalena/10_bismark_nucleotide_coverage_report/ \
