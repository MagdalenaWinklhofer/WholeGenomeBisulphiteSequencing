...
/cluster/projects/nn8014k/magdalena/.program_methylscore/nextflow run Computomics/MethylScore \
    --resume \
    --FORCE_RERUN=0 \
    --PROJECT_FOLDER=/cluster/work/users/magdalena/DMR/data/DMR_N_vs_R \
    --SAMPLE_SHEET=/cluster/work/users/magdalena/DMR/data/samplesheet_n_vs_r.tsv \
	--GENOME=/cluster/work/users/magdalena/DMR/data/ccar_genome_v1_262scaffolds_masked.fasta \
    -profile slurm \
    -work-dir /cluster/work/users/magdalena/DMR/data/DMR_N_vs_R/work \

# to close everything 
ml purge 

# squeue --me -o "%.18i %.9P %.28j %.8u %.2t %.10M %.6D %R %.10C %.10m" --iterate=5
